...
export const ONTOLOGY_CATALOG = Object.freeze({
  "http://blankdots.com/open/personasonto.owl":
    externalOntology("personasonto.owl"),
  "http://bubb.ghb.fh-furtwangen.de/TagOnt/tagont.owl":
    externalOntology("tagont.owl"),
  "http://geovocab.org/spatial": externalOntology("spatial.rdf"),
  "http://ontovibe.visualdataweb.org": externalOntology(
    "BenchmarkOntology.ttl",
  ),
  "http://ontovibe.visualdataweb.org/cardinalities": externalOntology(
    "ontovibe_cardinalities.ttl",
  ),
  "http://ontovibe.visualdataweb.org/imported": externalOntology(
    "BenchmarkOntologyModule.ttl",
  ),
  "http://protege.stanford.edu/plugins/owl/dc/protege-dc.owl":
    externalOntology("protege-dc.owl"),
  ...
  "http://rdf.vis.uni-stuttgart.de/stackexchange":
    externalOntology("StackExchange.ttl"),
  ...
  "http://webvowl.steffen-lohmann.de/ontobench-1.1.0-SNAPSHOT/ontology/1":
    externalOntology("fullontobench.ttl"),
  "http://webvowl.steffen-lohmann.de/ontobench-1.1.0-SNAPSHOT/ontology/39":
    externalOntology("allvalues.ttl"),
  "http://webvowl.steffen-lohmann.de/ontology/1": externalOntology(
    "full_ontobench_test.ttl",
  ),
  "http://www.cadmos.cirma.unito.it/drammar/2012/4/drammar.owl":
    externalOntology("Drammar_NunnaryScene_Optimized_Rules.owl"),
  "http://www.ics.forth.gr/isl/MarineTLO/v3/marinetlo.owl":
    externalOntology("marinetlo.owl"),
  "http://www.ics.forth.gr/isl/ontology/iMarineTLO":
    externalOntology("imarinetlo.owl"),
  ...
  "http://www.w3.org/TR/2003/PR-owl-guide-20031209/food":
    externalOntology("food.rdf"),
  "http://www.w3.org/TR/2003/PR-owl-guide-20031209/wine":
    externalOntology("wine.rdf"),
