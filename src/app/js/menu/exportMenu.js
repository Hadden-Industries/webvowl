...
module.exports = function ( graph ){
  ...
  function prepareOptionString( defOpts, currOpts ){
    ...
    for ( const name in defOpts ) {
      ...
      if ( Object.prototype.hasOwnProperty.call(defOpts, name) ) {// for travis warning
  ...
  function exportTex(){
    let ahAngle, center, controlPoints, curvePoint, dx, dy, endX, endY, len, lg, linkDomainIntersection, linkRangeIntersection, normX, normY, pathEnd, pathLen, pathStart, px, py, rx, ry, startX, startY;
                        graph.scaleFactor();
    graph.translation();
