      ...
      baseObjects.forEach(function ( element ){
        ...
        if ( Prototype ) {
          ...
          if ( element.attributes ) {
            const deduplicatedAttributes = d3.set(element.attributes.concat(node.attributes()));
    ...
    if ( baseObjects ) {
      baseObjects.forEach(function ( element ){
        ...
        if ( Prototype ) {
          ...
          if ( element.attributes ) {
            const deduplicatedAttributes = d3.set(element.attributes.concat(property.attributes()));
