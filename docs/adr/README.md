...
| ADR                                                                | Title                                              | Status   |
| ------------------------------------------------------------------ | -------------------------------------------------- | -------- |
| [0001](0001-docker-local-development.md)                           | Local Docker development for WebVOWL + OWL2VOWL    | Superseded |
| [0002](0002-prioritize-rdf-ingestion-and-early-webvowl-cutover.md) | Prioritize RDF ingestion and early WebVOWL cutover | Accepted |
